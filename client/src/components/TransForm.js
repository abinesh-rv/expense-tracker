  ...
  return (
    <div className="px-20">
        ...
        <form onSubmit={handleSubmit}>
          <div  className="flex md:flex-row md:max-w-[1000px] flex-col shadow shadow-cyan-400 mx-auto bg-slate-100 gap-3 md:gap-0 text-black p-5 justify-between items-center rounded-md">
          <div>
